(function ($) {
    $.fn.customModalForm = function () {
        var that = this;
        var overlay = $("<div class='loader-wrapper'><div id='loadingOverlay'><div class='fa fa-sync fa-spin'></div></div></div>");



         
        // overlay'in içine span class append et
        // direkt overlay'i append edersen body'de iki tane div oluyor
        ...
        var loadingWindow = $("<div class='modal fade' id='loadingModal1' tabindex='-1' role='dialog' aria-labelledby='loader' aria-hidden='true' data-keyboard='false' data-backdrop='static'>\
